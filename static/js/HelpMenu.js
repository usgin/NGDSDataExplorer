...
function helpBugsFeatures(){
	new Ext.Window({
		...
		items: [{
			xtype: 'panel',
			autoScroll: true,
			html: 'Report a bug or request a feature:<br> If reporting a bug, a detailed list of the steps that caused the bug would be most helpful.<br><br><a href="mailto:jalisdairi@gmail.com?subject=WFSClient">Send Email</a>'
			}
		]
	}).show();	
}
